<html lang="en"><head>
  ...
  <meta property="og:title" content="Certificate of completion from W3schools">
  <meta property="og:description" content="W3schools offers exams, courses, references and exercises in all the major languages of the web. Covering popular subjects like HTML, CSS, JavaScript, Python, SQL, Java and more.">
  <meta property="og:image" content="https://www.w3schools.com/images/w3schools_logo_436_2.png">
  <meta name="twitter:image" content="https://my-learning.w3schools.com/images/w3s-logo-256.png">
  <meta property="og:image:type" content="image/png">
  <meta property="og:image:width" content="436">
  <meta property="og:image:height" content="228">
  <!-- <meta property="og:url" content="https://verify.w3schools.com/" />
  <link rel=“canonical” href=“https://verify.w3schools.com/” /> -->
  ...
  <link rel="stylesheet" href="cookieconsent.css" media="all" onload="this.media='all'">
  <!-- Facebook Pixel Code -->
  <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script src="https://connect.facebook.net/signals/config/826641928224442?v=2.9.104&amp;r=stable" async=""></script><script async="" src="https://connect.facebook.net/en_US/fbevents.js"></script><script type="text/javascript">
    ...
    <div class="header">
      <a class="w3s-logo" href="https://www.w3schools.com/">
        <svg width="38" height="35" viewBox="0 0 38 35" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M15.9895 32.0535V34.866H14.7395V32.1428C14.7395 31.3392 14.2559 30.9077 13.6979 30.9077C13.1249 30.9077 12.4181 31.2425 12.4181 32.2172V34.8735H11.1681V27.1205H12.4255V30.6101C12.6711 29.9999 13.4821 29.7172 13.9806 29.7172C15.2752 29.7246 15.9895 30.5952 15.9895 32.0535Z" fill="#04AA6D"></path>
    ...
    <div class="body">
      <div class="body-item body-item-left">
        ...
        <div class="completion-date"><svg id="svgCheckMark" class="disabled" width="20" height="20" viewBox="0 0 20 20" fill="#798488" xmlns="http://www.w3.org/2000/svg" style="fill: rgb(5, 152, 98);">
          ...
          </svg> Completed: <span id="completionDate">May 18, 2022</span>
        </div>
        <img id="diplomaImgMobile" class="diploma-img diploma-img-mobile" src="dp.png">
        <a href="dp.png" download="certificate.png">
<button id="downloadBtn" class="btn download-btn">Download certificate</button>
      ...
      <div class="body-item body-item-right">
        <img id="diplomaImg" class="diploma-img" src="dp.png">
      </div>
  ...
  <script type="text/javascript" async="true" src="https://www.googletagmanager.com/gtag/js?id=UA-3855518-1"></script>
...
<script lang="javascript">
  ...
  const certId = pathnameSplit[pathnameSplit.length - 1];
  const subdomain = host.split('.')[0];
  
  let browserEnv = undefined;

  if (host.startsWith('localhost')) {
    browserEnv = 'local';
  } else if (subdomain.includes('-dev') || subdomain.includes('-local')) {
    browserEnv = 'dev';
  ...
  switch (browserEnv) {
    case 'local':
    case 'dev':
      getDataUrl = 'https://cert-api-dev.w3schools.com/data/' + certId;
      break;
    case 'stage':
      getDataUrl = 'https://cert-api-stage.w3schools.com/data/' + certId;
      break;
    case 'prod':
      getDataUrl = 'https://cert-api.w3schools.com/data/' + certId;
      break;
    default:
      console.log('No environment set. Using dummy data for testing.');
  }

  /* if (!browserEnv) {
    serverObject = dummyData;
    serverObject.date = new Date(serverObject.date);
    setTimeout(() => {
      initiatePageView(serverObject);
      displayError();
    }, 1000);
  } else { */
    try {
      fetch(getDataUrl)
        ...
        .then(data => {
            if (data && data.title && data.date) { // got a data object back
              serverObject = data;
              serverObject.date = new Date(serverObject.date);
